...
```bash
make unraid VERSION=0.2.2 UNRAID_VERSION=0.2.2 GITHUB_REPO=scoltzero/msf RELEASE_TAG=v0.2.2
```
...
gh release create v0.2.2 \
  dist/unraid/msf-0.2.2-x86_64-1.txz \
  dist/unraid/msf.plg \
  ...
  --title "v0.2.2" \
  --notes-file /tmp/msf-v0.2.2-release-notes.md
```

Recommended install URL for the v0.2.2 release:

```text
https://github.com/scoltzero/msf/releases/download/v0.2.2/msf.plg
```
