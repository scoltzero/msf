...
```bash
make unraid VERSION=0.3.6 UNRAID_VERSION=0.3.6 GITHUB_REPO=scoltzero/msf RELEASE_TAG=v0.3.6
```
...
gh release create v0.3.6 \
  dist/unraid/msf-0.3.6-x86_64-1.txz \
  dist/unraid/msf.plg \
  ...
  --title "v0.3.6" \
  --notes-file /tmp/msf-v0.3.6-release-notes.md
```

Recommended install URL for the v0.3.6 release:

```text
https://github.com/scoltzero/msf/releases/download/v0.3.6/msf.plg
```
