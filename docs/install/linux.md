...
| 架构 | 下载地址 |
|---|---|
| x86_64 / amd64 | `https://github.com/scoltzero/msf/releases/download/v0.3.9.3/msf-linux-amd64.tar.gz` |
| ARM64 / aarch64 | `https://github.com/scoltzero/msf/releases/download/v0.3.9.3/msf-linux-arm64.tar.gz` |
...
curl -L -o msf-linux-amd64.tar.gz \
  https://github.com/scoltzero/msf/releases/download/v0.3.9.3/msf-linux-amd64.tar.gz

tar -xzf msf-linux-amd64.tar.gz -C /tmp
sudo /tmp/msf-0.3.9.3-linux-amd64/install.sh
```
...
curl -L -o msf-linux-arm64.tar.gz \
  https://github.com/scoltzero/msf/releases/download/v0.3.9.3/msf-linux-arm64.tar.gz

tar -xzf msf-linux-arm64.tar.gz -C /tmp
sudo /tmp/msf-0.3.9.3-linux-arm64/install.sh
```
