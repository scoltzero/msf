...
| 架构 | FPK 资产 |
|---|---|
| x86 / amd64 | `https://github.com/scoltzero/msf/releases/download/v0.3.6/msf_0.3.6_x86.fpk` |
| ARM / arm64 | `https://github.com/scoltzero/msf/releases/download/v0.3.6/msf_0.3.6_arm.fpk` |
